...
import torchsde
from improved_diffusion.sc09_spectrogram_dataset import melspec_inv_standardize, melspec_standardize

from improved_diffusion.script_util import create_model_and_diffusion, model_and_diffusion_defaults
from improved_diffusion.sc09_spectrogram_dataset import *
...
class RevImprovedDiffusion(torch.nn.Module):
    ...
    def __init__(self, args, config=None, device=None):
        ...
        model.load_state_dict(torch.load(f'{model_dir}/model000100.pt', map_location='cpu'))
